            ...
            >
                ...
                >
                    <div className="flex flex-col items-center text-center space-y-6">
                        <h1
                            className={cn(
                                "text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-mono tracking-tight text-text-primary",
                                titleClassName,
                            )}
                        >
                            {title}
                        ...
                        {subtitle && (
                            <p
                                className={cn(
                                    "text-xl font-mono text-text-secondary max-w-3xl leading-relaxed",
                                    subtitleClassName,
                                )}
                            >
                                {subtitle}
                                    ...
                                    <a key={index} href={action.href}>
                                        <Button
                                            ...
                                            className={cn(
                                                ...
                                                action.variant === "default" && "bg-flame hover:bg-flame-dark shadow-lg shadow-flame/20 hover:shadow-xl hover:shadow-flame/30"
                                            )}
                                        >
                                            {action.label}
                                        </Button>
